...
namespace GGEZ
{
    ...
    {
        private static readonly fsSerializer s_serializer = new fsSerializer();
        ...
        public static object JsonToObject(string jsonString, System.Type type)
        {
            ...
            object deserialized = null;
            s_serializer.TryDeserialize(data, type, ref deserialized).AssertSuccessWithoutWarnings();
            return deserialized;
        }
        ...
        public static object JsonToObjectIgnoreErrors(string jsonString, System.Type type)
        {
            fsData data = fsJsonParser.Parse(jsonString);
            object deserialized = null;
            s_serializer.TryDeserialize(data, type, ref deserialized);
            return deserialized;
        }
    }
}
