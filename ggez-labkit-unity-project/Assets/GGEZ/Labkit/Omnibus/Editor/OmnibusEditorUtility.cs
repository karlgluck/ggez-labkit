    ...
    public static class OmnibusEditorUtility
    {
        ...
        public static Texture2D GridTexture
        {
            get
            {
                ...
                {
                    s_gridTexture = OmnibusEditorUtility.GenerateGridTexture(GridSize * 10, GridSize, new Color(0.9f, 0.9f, 0.9f), new Color(0.8f, 0.8f, 0.8f));
                }
        ...
        public static Texture2D SelectedBackgroundTexture
        {
            get
            {
                ...
                {
                    s_selectedBackgroundTexture = OmnibusEditorUtility.GenerateSolidColorTexture(64, SelectedColor);
                }
