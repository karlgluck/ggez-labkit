...
public void SetGameObject (string key, GameObject value) { this.SetObject (key, value); }
public void SignalGameObject (string key, GameObject value) { this.SignalObject (key, value); }
