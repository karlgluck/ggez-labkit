...
namespace GGEZ.Labkit
{
    ...
    public class EditorState
    {
        ...
        public GolemEditorUtility.NodeStyleColor NodeColor
        {
            get
            {
                switch (SpecialState)
                {
                    default:
                    case EditorSpecialStateType.Normal: return GolemEditorUtility.NodeStyleColor.Gray;
                    case EditorSpecialStateType.LayerEnter: return GolemEditorUtility.NodeStyleColor.Green;
                    case EditorSpecialStateType.LayerExit: return GolemEditorUtility.NodeStyleColor.Red;
                    case EditorSpecialStateType.LayerAny: return GolemEditorUtility.NodeStyleColor.Yellow;
                }
            }
        }
        ...
        private class DraggablePosition : IDraggable
        {
            ...
            {
                set { EditorState.Position.position = GolemEditorUtility.SnapToGrid(Position + value); }
            }
        }
        ...
        private class DraggableSize : IDraggable
        {
            ...
            public Vector2 Offset
            {
                set { EditorState.Position.size = GolemEditorUtility.SnapToGrid(Size + value); }
            }
        }
    }
