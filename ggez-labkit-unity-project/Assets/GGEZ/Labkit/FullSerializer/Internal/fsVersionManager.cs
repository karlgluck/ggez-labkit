...
namespace GGEZ.FullSerializer.Internal
{
    ...
    {
        private static readonly Dictionary<Type, fsOption<fsVersionedType>> s_cache = new Dictionary<Type, fsOption<fsVersionedType>>();
        ...
        public static fsOption<fsVersionedType> GetVersionedType(Type type)
        {
            ...
            if (s_cache.TryGetValue(type, out optionalVersionedType) == false)
            {
                ...
                s_cache[type] = optionalVersionedType;
            }
