...
namespace GGEZ.FullSerializer
{
    ...
    {
        private static Dictionary<fsConfig, Dictionary<Type, fsMetaType>> s_configMetaTypes =
            new Dictionary<fsConfig, Dictionary<Type, fsMetaType>>();

        public static fsMetaType Get(fsConfig config, Type type)
        {
            Dictionary<Type, fsMetaType> metaTypes;
            if (s_configMetaTypes.TryGetValue(config, out metaTypes) == false)
                metaTypes = s_configMetaTypes[config] = new Dictionary<Type, fsMetaType>();
        ...
        {
            s_configMetaTypes = new Dictionary<fsConfig, Dictionary<Type, fsMetaType>>();
        }
