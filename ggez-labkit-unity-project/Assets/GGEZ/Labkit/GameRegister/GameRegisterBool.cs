...
//----------------------------------------------------------------------
//----------------------------------------------------------------------
[Serializable, CreateAssetMenu (fileName = "New Bool Register.asset", menuName="GGEZ/Game Register/bool")]
public class GameRegisterBool : GameRegister
{
...
void Reset ()
    {
    this.listeners = new List<GameRegisterBoolListener>();
    this.runtimeValue = this.initialValue;
    }
