...
//----------------------------------------------------------------------
[Serializable]
public class UnityEventForGameRegisterFloatListener : UnityEvent<float>
{
}
...
//----------------------------------------------------------------------
[
AddComponentMenu ("GGEZ/Game Register Listener/float")
]
public class GameRegisterFloatListener : MonoBehaviour
{



[SerializeField] private GameRegisterFloat floatRegister;
[SerializeField] private UnityEventForGameRegisterFloatListener didChange;
...
#if UNITY_EDITOR
    this.registeredGameRegisterIn = this.floatRegister;
#endif
    }
...
//----------------------------------------------------------------------
// Handle the Unity Editor changing gameEfloatRegister in the inspector
//----------------------------------------------------------------------
#if UNITY_EDITOR
#region Editor Runtime
[Header ("Editor Runtime")]
private GameRegisterFloat registeredGameRegisterIn;
...
void OnValidate ()
    ...
    if (this.registeredGameRegisterIn != null
            && !object.ReferenceEquals (this.registeredGameRegisterIn, this.floatRegister))
        {
