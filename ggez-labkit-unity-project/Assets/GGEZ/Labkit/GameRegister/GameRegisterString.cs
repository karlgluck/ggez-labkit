...
void Reset ()
    {
    this.listeners = new List<GameRegisterStringListener>();
    this.runtimeValue = this.initialValue;
    }
...
private List<GameRegisterStringListener> listeners = new List<GameRegisterStringListener>();





public void RegisterListener (GameRegisterStringListener listener)
    {
    if (listener == null)
        {
...
public void UnregisterListener (GameRegisterStringListener listener)
    {
    if (listener == null)
        {
        throw new ArgumentNullException ("listener");
