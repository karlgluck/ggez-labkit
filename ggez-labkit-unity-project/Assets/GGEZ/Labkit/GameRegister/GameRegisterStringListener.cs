...
//----------------------------------------------------------------------
[Serializable]
public class UnityEventForGameRegisterStringListener : UnityEvent<string>
{
}
...
//----------------------------------------------------------------------
[
AddComponentMenu ("GGEZ/Game Register Listener/string")
]
public class GameRegisterStringListener : MonoBehaviour
{




[SerializeField] private GameRegisterString stringRegister;
[SerializeField] private UnityEventForGameRegisterStringListener didChange;
...
#if UNITY_EDITOR
    this.registeredGameRegisterIn = this.stringRegister;
#endif
    }
...
//----------------------------------------------------------------------
// Handle the Unity Editor changing gameEstringRegister in the inspector
//----------------------------------------------------------------------
#if UNITY_EDITOR
#region Editor Runtime
[Header ("Editor Runtime")]
private GameRegisterString registeredGameRegisterIn;
...
void OnValidate ()
    ...
    if (this.registeredGameRegisterIn != null
            && !object.ReferenceEquals (this.registeredGameRegisterIn, this.stringRegister))
        {
