...
namespace GGEZ.FullSerializer.Tests {
    ...
    public class VersionedTypeTests {
        ...
        public void DuplicateVersionString() {
            Assert.That(() =>  fsVersionManager.GetVersionedType(typeof(VersionedModelDuplicateVersionString)), Throws.InstanceOf<fsDuplicateVersionNameException>());
        }

        [Test]
        public void MissingConstructor() {
            Assert.That(() =>  fsVersionManager.GetVersionedType(typeof(VersionedModelMissingConstructor)), Throws.InstanceOf<fsMissingVersionConstructorException>());
        }
